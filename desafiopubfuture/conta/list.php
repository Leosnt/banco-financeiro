...
if (!empty($pagina)) {
    ...
    $query_registros = "SELECT id, conta, tipo_de_conta, instituicao, saldo FROM cadastro_conta ORDER BY id DESC LIMIT $inicio, $qnt_result_pg";
    ...
    $query_pg = "SELECT COUNT(id) AS num_result FROM cadastro_conta";
