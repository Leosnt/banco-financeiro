            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="cad-registro-form" class="row g-4">
                        ...
                        <div class="col-md-4">
                            <label for="inputTipoDeDespesa" class="form-label">Tipo de despesa:</label>
                            <select id="tipoDespesa" class="form-select"  name="tipo_de_despesa">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <dl class="row">
                        ...
                        <dt class="col-sm-3">Tipo de Despesa</dt>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-registro-form" class="row g-4">
                        ...
                        <div class="col-md-4">
                            <label for="inputTipoDeDespesa" class="form-label">Tipo de despesa:</label>
                            <select class="form-select"  name="tipo_de_despesa" id="editDesp">
                                <option selected>---Selecione---</option>
                                <option>Alimentação</option>
                                <option>Educação</option>
                                <option>Lazer</option>
