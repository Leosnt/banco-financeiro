...
if (!empty($pagina)) {
    ...
    $query_registros = "SELECT id, conta, tipo_de_despesa, valor, data_de_pagamento, data_de_vencimento FROM cadastro_despesa ORDER BY id DESC LIMIT $inicio, $qnt_result_pg";
    ...
    $query_pg = "SELECT COUNT(id) AS num_result FROM cadastro_despesa";
