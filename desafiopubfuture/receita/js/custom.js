...
cadForm.addEventListener("submit", async (e) => {
    ...
    } else if (document.getElementById("valor")!= null){
        msgAlertaErroCad.innerHTML = "<div class='alert alert-danger' role='alert'>Erro: Necessário preencher o campo valor!</div>";
    } else {
...
async function editregistroDados(id) {
    ...
    if (resposta['erro']) {
        ...
        document.getElementById("editRec").value = resposta['dados'].tipo_de_receita;
        document.getElementById("editValor").value = resposta['dados'].valor;
        document.getElementById("editDataV").value = resposta['dados'].data_de_vencimento;
        document.getElementById("editDataP").value = resposta['dados'].data_de_pagamento;
        document.getElementById("editDesc").value = resposta['dados'].descricao;
    }
}
